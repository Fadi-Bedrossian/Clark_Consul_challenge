...
#get nodename and ipaddr in variables then assign it in config.jason file
nodename=$(hostname)
ipaddr=$(hostname -i)
...
#add config to jason file and assign nodename and ipaddr variables in consul.conf file
